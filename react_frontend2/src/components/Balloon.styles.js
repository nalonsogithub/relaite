...
const balloonsLeftUpKFAnimation = ({ left, hangOnTop }) => keyframes`
  {
    0%{ 
      top: 100vh;
      left: ${left}vw;
...
const balloonsRightUpKFAnimation = ({ left, hangOnTop }) => keyframes`
  {
    0%{ 
      top: 100vh;
      left: ${left}vw;
...
export const StyledBalloon = styled.div`
  ...
  z-index: 10;
  animation: ${(props) => (props.animate.left > 50 ? balloonsRightUpKFAnimation(props.animate) : balloonsLeftUpKFAnimation(props.animate))} ease-in-out
