...
const Carousel = ({ onCollapse }) => {
  ...
  useEffect(() => {
    console.log("Current state of images:", images.map(img => `ID: ${img.id}, Active: ${img.active}`));
  }, [images]);
  ...
  return (
    <div className={isExpanded ? styles.carouselExpanded : styles.carouselCollapsed}>
