...
const LCClient = () => {
	...
	const [listingID, setListingID] = useState('listing_1');
        ...
        <div>
            ...
            {chatState === 'normal' && (
                <Draggable handle=".chat-header">
                    <div className={`chat-window chat-window-normal`}>
            ...
            {chatState === 'maximized' && (
                <div className="chat-window chat-window-maximized">
                    <div className="chat-header">
                        <div>Chat</div>
                        <div>
                            <button onClick={minimizeChat}>_</button>
                    ...
                    <div className="chat-log chat-log-maximized">
                        <div>
                            <h4>Chat Log</h4>
                            {chatLog.map((msg, index) => (
                                <div key={index}>
